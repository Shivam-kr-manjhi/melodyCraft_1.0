...
#     <style>
#     body {
#         background: linear-gradient(180deg, rgba(0, 0, 0, 0.8) 0%, rgba(0, 0, 0, 0.95) 100%), url('https://example.com/background-image.jpg');
#         background-size: cover;
#         background-blur: 10px; /* Adjust blur strength as needed */
#     }
#     </style>
# """
